...
/**
 * Implementation of the PaymentService which returns all payment methods for people living in
 * Konstanz and prepayment for all others.
 * 
 * @author meiglspe
 *
 */
public class PaymentMethodServiceImpl implements PaymentMethodService {
   ...
   * a given amount.
   * 
   * @param address The name and address of the person for which the payment method should be
   *        determined..
  ...
  public List<PaymentMethod> getAcceptedMethods(Address address, int amount, Currency currency)
    ...
    // check properties
    boolean inBlacklist =
        Arrays.asList(blacklist).contains(address.getFirstname() + "/" + address.getSurname());
